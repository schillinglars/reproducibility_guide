...
# Save the plot
ggsave("outputs/figs/mtcars_plot.png", plot = plot, width = 6, height = 4)
```
...
# Save the plot
plt.savefig("outputs/figs/mtcars_plot.png", dpi=300, bbox_inches
```
