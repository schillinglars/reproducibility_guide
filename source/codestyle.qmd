...
This document was last rendered on `r Sys.Date()`.

::: callout-information
To better understand the source code behind the in-line code and other style related code syntax it is recommended to click on the `</>Code`-button in the top right corner of this page.
:::
