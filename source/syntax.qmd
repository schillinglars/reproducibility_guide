...
This document was last rendered on the `\r Sys.Date()` will display without the `\` as `r Sys.Date()`.

::: callout-note
To better understand the source code behind the in-line code and other style related code syntax it is recommended to click on the `</>Code`-button in the top right corner of this page and select "Show source code". This will show you the source code of the respective page.
:::
